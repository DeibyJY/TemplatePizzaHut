class VariantQuickViewSelects extends HTMLElement {
    ...
    updateAttribute(unavailable = true, disable = true){
        ...
        console.log('Estoy ejecutnado esto 3');
                ...
                if(this.notifyMe){
                    this.notifyMe.querySelector('.scoder-notify-product-variant').value = this.currentVariant.title;
...
function showWarning(content, time = null) {
    ...
    const warningPopupContent = document.getElementById('scoder-warning-popup').querySelector('[data-scoder-warning-content]')
